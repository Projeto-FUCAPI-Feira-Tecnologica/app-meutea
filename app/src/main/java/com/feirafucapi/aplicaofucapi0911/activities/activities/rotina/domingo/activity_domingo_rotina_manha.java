...
import com.feirafucapi.aplicaofucapi0911.activities.activities.rotina.sabado.activity_sabado_rotina_tarde;
...
public class activity_domingo_rotina_manha extends AppCompatActivity {

    private ImageButton btnVoltar;
    private RecyclerView recyclerViewDom;
    private List<Rotina> listaRotinasDomM = new ArrayList<>();
    private MaterialButton mbtoTarde;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_domingo_rotina_manha);

        recyclerViewDom = findViewById(R.id.recyclerViewRotinaDOMM);
        mbtoTarde = findViewById(R.id.materialButtonNtoTardeDomingo);

        AdaptadorRotina adaptador = new AdaptadorRotina(listaRotinasDomM);
        ...
        mbtoTarde.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), activity_domingo_rotina_tarde.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
    ...
    public void criarRotinas(){ // Parte que será adicionada do banco de dados
        ...
        this.listaRotinasDomM.add(rotina);

...
public class activity_domingo_rotina_noite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_domingo_rotina_noite);

        recyclerViewDom = findViewById(R.id.recyclerViewRotinaDOMN);

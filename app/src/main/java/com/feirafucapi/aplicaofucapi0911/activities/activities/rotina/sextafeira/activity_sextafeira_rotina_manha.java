...
public class activity_sextafeira_rotina_manha extends AppCompatActivity {

    private ImageButton btnVoltar;
    private RecyclerView recyclerViewSEX;
    private List<Rotina> listaRotinasSEXM = new ArrayList<>();
    private MaterialButton mbtoTarde;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sextafeira_rotina_manha);

        recyclerViewSEX = findViewById(R.id.recyclerViewRotinaSEXM);
        mbtoTarde = findViewById(R.id.materialButtonNtoTardeSEXTA);

        AdaptadorRotina adaptador = new AdaptadorRotina(listaRotinasSEXM);
    ...
    public void criarRotinas(){ // Parte que será adicionada do banco de dados
        ...
        this.listaRotinasSEXM.add(rotina);
